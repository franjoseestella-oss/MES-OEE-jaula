...
-- Current progress time limit (let's use 2026-06-29 10:00:00 UTC as progress time, after alarm ended at 09:25:37)
DECLARE @CurrentProgressTime DATETIME = '2026-06-29T10:00:00Z';
...
while True:
    try:
        if cursor.description is not None:
            ...
            # Let's filter to slot 10 (which represents sequence 236 bastidor 307374) to see its timeline transitions
            for r in rows:

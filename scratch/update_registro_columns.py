...
select_fields = """SELECT
  ...
  REPLACE(CAST(CAST(TIEMPO_ELEVACION_MIN_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_ELEVACION_MIN_SINCARGA,
  REPLACE(CAST(CAST(TIEMPO_ELEVACION_MAX_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_ELEVACION_MAX_SINCARGA,
  CASE
    ...
    THEN REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ...
    THEN N'🟢 ' + REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ELSE N'🔴 ' + REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
  END AS TIEMPO_ELEVACION_MEDIDO_SINCARGA,
  REPLACE(CAST(CAST(TIEMPO_DESCENSO_MIN_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_DESCENSO_MIN_SINCARGA,
  REPLACE(CAST(CAST(TIEMPO_DESCENSO_MAX_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_DESCENSO_MAX_SINCARGA,
  CASE
    ...
    THEN REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ...
    THEN N'🟢 ' + REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ELSE N'🔴 ' + REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_SINCARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
  END AS TIEMPO_DESCENSO_MEDIDO_SINCARGA,
  ESTADO_SINCARGA AS ESTADO_SINCARGA,
  REPLACE(CAST(CAST(TIEMPO_ELEVACION_MIN_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_ELEVACION_MIN_CARGA,
  REPLACE(CAST(CAST(TIEMPO_ELEVACION_MAX_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_ELEVACION_MAX_CARGA,
  CASE
    ...
    THEN REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ...
    THEN N'🟢 ' + REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ELSE N'🔴 ' + REPLACE(CAST(CAST(TIEMPO_ELEVACION_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
  END AS TIEMPO_ELEVACION_MEDIDO_CARGA,
  REPLACE(CAST(CAST(TIEMPO_DESCENSO_MIN_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_DESCENSO_MIN_CARGA,
  REPLACE(CAST(CAST(TIEMPO_DESCENSO_MAX_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS TIEMPO_DESCENSO_MAX_CARGA,
  CASE
    ...
    THEN REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    WHEN TIEMPO_DESCENSO_MEDIDO_CARGA >= TIEMPO_DESCENSO_MIN_CARGA
     AND TIEMPO_DESCENSO_MEDIDO_CARGA <= TIEMPO_DESCENSO_MAX_CARGA
    THEN N'🟢 ' + REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
    ELSE N'🔴 ' + REPLACE(CAST(CAST(TIEMPO_DESCENSO_MEDIDO_CARGA AS DECIMAL(10,2)) AS VARCHAR), '.', ',') + ' s'
  ...
  REPLACE(CAST(CAST(ALTURA_INICIAL AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS ALTURA_INICIAL,
  REPLACE(CAST(CAST(ALTURA_FINAL AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS ALTURA_FINAL,
  REPLACE(CAST(CAST(DIFERENCIA_ALTURAS AS DECIMAL(10,2)) AS VARCHAR), '.', ',') AS DIFERENCIA_ALTURAS,

...
# We will use Romance Standard Time to determine the plot date, just like the dashboard query.
# Let's get Romance Standard Time from system or calculate it.
# We know the current system is in Romance Standard Time.
plot_date = datetime.date(2026, 6, 29) # fixed to today's date
...
print("CURRENT TIMELINE ROWS FOR ACTIVE SEQS:")
while True:
    try:
        rows = cursor.fetchall()
        for r in rows:
            if '0270' in r[1] or '0271' in r[1]:

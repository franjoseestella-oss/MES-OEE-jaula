...
while True:
    try:
        if cursor.description is not None:
            ...
            # If the columns match the final select, break
            if len(cursor.description) == 3 and cursor.description[0][0] == 'time':
                break
...
if results:
    for r in results:
        if r[2] == 'Alarma' or any(seq in r[1] for seq in ['0266', '0267', '0268', '0269']):
            print(r)

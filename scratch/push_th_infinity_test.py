...
panel_15["fieldConfig"] = {
    "defaults": {
        ...
        "thresholds": {
            "mode": "absolute",
            "steps": [
                {"color": "#E32636", "value": None}  # default fallback base
            ]
        }
    },
    "overrides": []
...
# SQL Target: return measured values + Base (as -Infinity) + Min + Max columns
sql = (
    "SELECT TOP 1 "
    "COALESCE(TIEMPO_ELEVACION_MEDIDO_SINCARGA, 0.0) AS [Elevacion Sin Carga], "
    "'-Infinity' AS [Elevacion Sin Carga Base], "
    ...
    "'-Infinity' AS [Descenso Sin Carga Base], "
    ...
    "'-Infinity' AS [Elevacion Con Carga Base], "
    ...
    "'-Infinity' AS [Descenso Con Carga Base], "
...
payload = {
    ...
    "overwrite": True,
    "message": "3-step dynamic thresholds with -Infinity"
}
if folder_uid:

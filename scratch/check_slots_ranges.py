...
SELECT slot_idx, secuencia, bastidor, DATEADD(hour, @UTCOffset, planned_start) AS planned_start_local, DATEADD(hour, @UTCOffset, planned_end) AS planned_end_local FROM #SeqsToSchedule;
"""

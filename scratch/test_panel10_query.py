...
def inspect():
    ...
    DECLARE @PlotDate DATE = CAST('2026-06-24' AS DATE);
    ...
    -- Current progress time (simulated to end of shift)
    DECLARE @CurrentProgressTime DATETIME = @ShiftEndDT;
    ...
    WITH OrderedERP AS (
        SELECT 
            ...
            ROW_NUMBER() OVER (ORDER BY TRY_CAST(secuencia AS INT) ASC) as global_seq_idx
        FROM dbo.JAULA_ERP

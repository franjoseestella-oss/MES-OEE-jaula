...
# Configure the field defaults: min=1, max=6, color mode to thresholds
...
# SQL Target: return measured values and thresholds
sql = (
    "SELECT TOP 1 "
...
payload = {
    ...
    "overwrite": True,
    "message": "Configured dynamic 3-step thresholds with patched handler"
}
if folder_uid:

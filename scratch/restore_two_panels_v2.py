...
panel_11["options"] = {
    ...
    "reduceOptions": {
        ...
        "fields": "",
        "values": False  # Use Calculate (shows fields) instead of All Values
    },
    "showUnfilled": True,
    "sizing": "auto",
    "valueMode": "color"
...
payload = {
    ...
    "overwrite": True,
    "message": "Restore Gauge for OEE GLOBAL and Bar Gauge (Calculate mode) for METRICAS OEE next to it"
}
